...
export default function KomojuButton({ planId, planLabel, className }: Props) {
  ...
  return (
    <div>
      <button onClick={handleClick} disabled={loading} className={className ?? "w-full bg-purple-600 text-white font-bold py-3 rounded-xl hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"}>
